...
public class LocalManagedObjectAdvisorTest {
  ...
  /**
   * Verify the ACL given to constructor is set on the advisor context if it is root object
   * operation.
   */
  @Test
  ...
  /**
   * Verify the ACL given to constructor is not set on the advisor context if it is not root object
   * operation.
   */
  @Test
